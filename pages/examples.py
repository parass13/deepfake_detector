...
def layout():
    return gr.Row([
        gr.Textbox(
            value="""Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vel augue 
...
pretium massa, ut dictum nibh.""",
        ...
        gr.Textbox(
            value="""Etiam dolor sem, bibendum id lacus eget, porta hendrerit mauris. Fusce varius 
